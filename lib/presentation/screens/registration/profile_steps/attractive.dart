...
class Attractive extends StatefulWidget {
  const Attractive({Key? key, required this.onComplete, required this.onPrev}) : super(key: key);
  final Function(String? attractive) onComplete;
  final Function onPrev;

  @override
  State<Attractive> createState() => _AttractiveState();
}

class _AttractiveState extends State<Attractive> {
  String value = '';
